...
const getItemStyle = (isDragging, draggableStyle) => ({
  ...
  background: isDragging ? primaryBlueColor : "#e9f3ff",
...
const getListStyle = (isDraggingOver) => ({
  background: isDraggingOver ? "#ebebeb" : "#e9f3ff",
  padding: grid,
  width: "100%", // 250
});
const optionsList = [
...
function ClozeWithDragAndDropDraggableItem(props) {
...
export default ClozeWithDragAndDropDraggableItem;
