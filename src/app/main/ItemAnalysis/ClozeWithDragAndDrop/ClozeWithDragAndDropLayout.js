...
const ClozeWithDragAndDropLayout = (props) => {
  ...
  useEffect(() => {
    if (props.questionId != null) {
      ...
      console.log('filteredQuestion in Close with Drag and drop ', _filteredQuestion);
    ...
    >
      ...
      <form className="px-0 sm:px-24 ">
        <div className="mb-24 flex justify-between flex-wrap wrap">
          <h2 className="pose-h2 font-bold tracking-tight">Cloze With Drag & Drop</h2>
          <div>
        ...
        <div className="space-y-32">
          ...
          <div>
              ...
              {multipleChoices &&
                multipleChoices.map((item, index) => {
                  return (
                    ...
                    >
                      <h3 style={{ marginBottom: '10px' }}>Group {index + 1}</h3>
                      <TextField
                        className="mt-12"
                        style={{ width: '100%' }}
                        inputProps={{
                        ...
                        onChange={(e) => {
                          const tempState = [...multipleChoices];
            ...
            <div style={{ marginTop: '10px' }} className="flex items-center">
              <Fab onClick={() => onNewOptionAdded()} color="primary" aria-label="add">
                <AddIcon />
              </Fab>
