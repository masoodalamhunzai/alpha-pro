...
const SetUserAccess = () => {
  ...
  return (
    <div>
      ...
      >
        <Typography variant="h5" sx={{ margin: '10px 5px', fontWeight: 'bold' }}>
            ...
            >
              ...
              <CardContent sx={{ width: '100%' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                  <FormGroup>
                    <FormControlLabel control={<Checkbox />} label="Activity Manager" />
                    <FormControlLabel control={<Checkbox />} label="Bulk Update Manager" />
                    <FormControlLabel control={<Checkbox />} label="Tag Manager" />
                  </FormGroup>
                  <FormGroup>
                    <FormControlLabel control={<Checkbox />} label="Tag Hierarchy Manager" />
          ...
          <Grid item xs={6}>
            ...
            >
              ...
              <CardContent sx={{ width: '100%' }}>
                ...
                <FormGroup sx={{ display: 'inline-block' }}>
                  <FormControlLabel control={<Checkbox />} label="Management Admin" />
                  <FormControlLabel control={<Checkbox />} label="User Manager" />
                  <FormControlLabel control={<Checkbox />} label="System Admin" />
                </FormGroup>
                <div className="flex justify-between my-5">
                  <p style={{ fontSize: '11px' }} className="font-semibold text-gray-500">
                    Insight roles
                ...
                <FormControlLabel control={<Checkbox />} label="Insight Access" />
                <div className="flex justify-between my-5">
                  <p style={{ fontSize: '11px' }} className="font-semibold text-gray-500">
                    Insight roles
                  </p>
                </div>
                <FormControlLabel control={<Checkbox />} label="Aurthor Site Setting Manager" />
              </CardContent>
            </Card>
          </Grid>
        </Grid>
        ...
        >
          ...
          The new user newuser@gmail.com will be sent an email with a set password link that will
          expire in 7 days.
        </Typography>
        <div className="flex justify-between my-5">
          <Button
