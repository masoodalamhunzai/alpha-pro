        ...
        >
          <Box sx={{ padding: '10px' }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <span className="text-gray-500 text-base w-full block">Used In* :</span>
              <Stack
                spacing={3}
                direction="row"
                alignItems="center"
              ...
              >
                {usedInArr?.map((item) => (
                  <Button
                    ...
                    variant="contained"
                    className={
                      item.id === usedInStatus ? classes.buttonGrey : classes.buttonSelected
                    }
            ...
            <Box sx={{ padding: '10px 20px' }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                ...
                >
                  ...
                  <Button type="submit" variant="contained" className={classes.deleteBtn}>
                    Delete
                  </Button>
                </Stack>
              </Box>
